...
<body class="sub_page">
  ...
  <section class="contact_section layout_padding">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <form action="sineupAction.jsp" method="post">
            <div>
           ...
           <span>Login here</span>
              ...
              {
              %>
            	  <h5>Registration Successfully Done Login here</h5>
        ...
        <div class="col-md-6">
          <div class="map_container">
            <div class="map-responsive">
             <img src="images/Register.jpg" alt="Image" width=330px; style="margin-left: 17px; border-radius:12px;">
            </div>
          </div>
        </div>
      </div>
